...
prefix='model4' ###### <------------- enter model name her 
   ...
   #     self.fulda = p.NewOpenStorage(name="Fulda",x=0,y=0,z=0, area = 3.3*10**6)
    ...
    def setparameters(self,
     ...
     #   fulda = self.fulda
        ...
        cmf.kinematic_wave(c.surfacewater,outlet,tr_surf)
        ...
        cmf.kinematic_wave(c.layers[0],outlet,tr_soil_fulda/V0_soil, V0 = V0_soil)        
        ...
        cmf.kinematic_wave(c.layers[2], outlet, tr_GW_l)        
