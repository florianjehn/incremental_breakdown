...
prefix='model13' ###### <------------- enter model name her 
    ...
    def __init__(self,begin,end, with_valid_data = False, shift_one_day = False):
        ...
        self.params = [param('tr_soil_GW',0.5,150.),
                ...
                #       param("tr_GW_u_GW_l", 10., 750.),
                       ...
                       param("TW_threshold", 30.,200.),

                       # LAI = leaf area index
                       param('LAI', 1.,12.),
                       # Canopy Closure
                       param("CanopyClosure",0.,0.3),
